...
impl From<UiString> for engine::UiString {
    fn from(s: UiString) -> Self {
        match s {
            ...
            UiString::SectionSetlist => engine::UiString::SectionSetlist,
            UiString::ValueSetlistNumber => engine::UiString::ValueSetlistNumber,
            UiString::LabelSetlistName => engine::UiString::LabelSetlistName,
            UiString::ValueSetlistStep => engine::UiString::ValueSetlistStep,
            UiString::ValueSetlistEmpty => engine::UiString::ValueSetlistEmpty,
            UiString::HintSetlist => engine::UiString::HintSetlist,
            UiString::ButtonAddCurrentKit => engine::UiString::ButtonAddCurrentKit,
            UiString::ButtonMoveStepUp => engine::UiString::ButtonMoveStepUp,
            UiString::ButtonMoveStepDown => engine::UiString::ButtonMoveStepDown,
...
impl From<engine::UiString> for UiString {
    fn from(s: engine::UiString) -> Self {
        match s {
            ...
            engine::UiString::SectionSetlist => Self::SectionSetlist,
            engine::UiString::ValueSetlistNumber => Self::ValueSetlistNumber,
            engine::UiString::LabelSetlistName => Self::LabelSetlistName,
            engine::UiString::ValueSetlistStep => Self::ValueSetlistStep,
            engine::UiString::ValueSetlistEmpty => Self::ValueSetlistEmpty,
            engine::UiString::HintSetlist => Self::HintSetlist,
            engine::UiString::ButtonAddCurrentKit => Self::ButtonAddCurrentKit,
            engine::UiString::ButtonMoveStepUp => Self::ButtonMoveStepUp,
            engine::UiString::ButtonMoveStepDown => Self::ButtonMoveStepDown,
